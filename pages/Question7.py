...
def main():
    ...
    with col2:
        st.title("Do you like to make decisions quick or do you like to take your time to look at it from different sides?")
        text_input = st.text_input("Your Answer")

    # Button to move to Question 2
    with col2:
        if st.button("Move to Question 8"):
            common_list.append(text_input)
            session_state.common_list = common_list
            st.switch_page('pages/Question8.py')
